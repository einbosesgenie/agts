...
<header class="header">
    <div class="container">
        <div class="header__content">
            ...
            <div class="header__phone--mobile"><a href="tel:{{setting('site.telephone')}}">{{setting('site.telephone')}}</a></div>
            ...
            <div class="header__action-group">
                ...
                <div class="header__action-group--desktop">
                    <div class="header__contact"><a class="header__phone--desktop" href="tel:{{setting('site.telephone')}}">{{setting('site.telephone')}}</a><a class="btn btn-empty header__feedback-btn" href="javascript:;">Обратная связь</a></div>
                        ...
                        <div class="nav__content">
                            @foreach($catalogsTree as $catalogs)
                                @if(array_key_exists('childs', $catalogs))
                                    <div class="nav__li has-children"><a href="/catalog/category/{{$catalogs['id']}}">{{$catalogs['display_name']}}</a>
                                        <div class="nav__content">
                                                        ...
                                                        <div class="nav__content">
                                                            @foreach($children['childs'] as $childrenSecond)
                                                                @if(array_key_exists('childs', $childrenSecond))
                                                                    <div class="nav__li has-children"><a href="/catalog/category/{{$childrenSecond['id']}}">{{$childrenSecond['display_name']}}</a>
                                                                        <div class="nav__content">
                                                                            @foreach($childrenSecond['childs'] as $childrenThird)
                                                                                <div class="nav__li"><a href="/catalog/category/{{$childrenThird['id']}}">{{$childrenThird['display_name']}}</a></div>
                                                                            @endforeach
                                                                        </div>
                                                                    </div>
                                                                @else
                                                                    <div class="nav__li"><a href="/catalog/category/{{$childrenSecond['id']}}">{{$childrenSecond['display_name']}}</a></div>
                                                                @endif
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                @else
                                                    <div class="nav__li"><a href="/catalog/category/{{$children['id']}}">{{$children['display_name']}}</a></div>
                                                @endif
                                            @endforeach
                                        </div>
                                    </div>
                                @else
                                    <div class="nav__li"><a href="/catalog/category/{{$catalogs['id']}}">{{$catalogs['display_name']}}</a></div>
                                @endif
                            @endforeach
                        </div>
                    </div>
